...
In 2007 these three used 3.9\% where as in 2012 this was 4.6\%.
...
\end{itemize}
This question will be answered using several sub questions. Of which the first one is 'What is the energy consumption of each WiFi standard?'\\
This question will be answered in section \ref{researchExperiment} using an experiment measuring both data transfer energy consumption and idle power consumption. It will provide insight into the energy consumption of each WiFi standard, such an bad utilisation of the WiFi standards can be avoided. Next to this, this will provide the ability to accurately calculate energy consumption of different scenarios.
